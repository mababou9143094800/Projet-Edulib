...
<div class="container">
  <div class="admin-layout">
    ...
    <div>
        ...
        <div class="filters__form">
          ...
          <div class="filters__actions">
            ...
            <?php if ($search || $status): ?>
              <a href="/backend/admin/resources.php" class="btn btn--ghost btn--sm">Effacer</a>
            <?php endif; ?>
          </div>
        </div>
      </form>
      ...
      <?php if ($resources): ?>
        <form method="post" action="/backend/admin/bulk-resources.php" id="bulk-form">
                    ...
                    <td>
                      <div class="td-actions">
                        ...
                        <form method="post" action="/delete-resource.php"
                          ...
                          <input type="hidden" name="redirect" value="/backend/admin/resources.php">
