    ...
    <form method="get" action="" class="filters__form">
      ...
      <div class="filters__actions">
        ...
        <?php if ($cat_id || $search): ?>
          <a href="/frontend/resources.php" class="btn btn--ghost btn--sm">Effacer</a>
        <?php endif; ?>
      </div>
    </form>
  </div>
  ...
  <?php if ($resources): ?>
    ...
    <?php if ($total_pages > 1): ?>
      <nav class="pagination" aria-label="Pagination">
        <?php
        $base = '/frontend/resources.php?' . http_build_query(array_filter(['q' => $search, 'categorie' => $cat_id ?: null]));
        ?>
  ...
  <?php else: ?>
    <div class="empty-state">
      ...
      <p class="empty-state__desc text-muted">
        ...
        <a href="/backend/add-resource.php">déposer une ressource</a>.
      </p>
    </div>
  <?php endif; ?>
